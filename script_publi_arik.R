...
aAIC_arik <- 14973*log(best_model_gam_arik$sig2) + (2*sum(best_model_gam_arik$edf)) # for the GAM
GAMM_arik<-forecast::auto.arima(best_model_gam_arik$residuals) # 5 df
aAIC_GAMM_arik <- (14973*log(GAMM_arik$sigma2)) + (sum(best_model_gam_lewi$edf) + 5) # for the GAMM
